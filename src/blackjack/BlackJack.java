...
public class BlackJack {
  ...
  public static void main(String[] args) {
    ...
    // using at least 4 different colors (except if the number given is smaller than four,
    // than all cards should have different colors)
    // We should be able to shuffle the deck, which randomly orders the cards
    // We should be able to draw the top card which returns the drawn card and also removes it
    // from the deck
